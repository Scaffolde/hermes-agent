...
def test_write_json_serializes_concurrent_writes(monkeypatch):
    ...
    test_frames = [frame for frame in frames if frame.get("text") == "x" * 24]

    # Other tests in this module can still have a valid background event in
    # flight. Its presence is harmless; malformed/interleaved JSON is not.
