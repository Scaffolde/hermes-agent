...
class TestFailureAttribution:
    ...
    def _make_pool(self, tmp_path, monkeypatch, entries):
        ...
        # Pool tests must not absorb the developer's real Claude Code OAuth
        # singleton from ~/.claude; that turns the intended one-entry fixture
        # into a two-entry pool and invalidates the rotation assertion.
        monkeypatch.setattr(
